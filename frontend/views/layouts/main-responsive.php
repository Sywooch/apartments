...
<a href="#openModal_bonus" class="sidebar_btn sidebar_bonus"><?= Yii::t('app', 'Бонусная программа') ?></a>
<a href="#openModal_client" class="sidebar_btn sidebar_customers"><?= Yii::t('app', 'Постоянным клиентам') ?></a>
<a href="#openModal_friend" class="sidebar_btn sidebar_friend"><?= Yii::t('app', 'Засели друга') ?></a>
